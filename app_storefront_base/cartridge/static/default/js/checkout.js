      ...
      methods: {
        ...
        optionValueForAddress: function (e, t, i, r) {
          var n = r || {},
            ...
            d = !e;
          if ('string' == typeof e)
            return $('<option class="' + s + '" disabled>' + e + '</option>');
          var l = e || {},
            c = l.shippingAddress || {};
          a &&
            d &&
          ...
          m.val(p),
            d
              ...
              : ((u = []),
                ...
                c.stateCode && u.push(c.stateCode),
                c.postalCode && u.push(c.postalCode),
                !a &&
                  l.selectedShippingMethod &&
                  (u.push('-'), u.push(l.selectedShippingMethod.displayName)),
                (u = u.length > 2 ? u.join(' ') : i.resources.newAddress)),
            m.text(u);
          var h = {
      ...
      addNewAddress: function () {
        $('.btn-add-new').on('click', function () {
          ...
          if (e.parents('#dwfrm_billing').length > 0) {
            ...
            r.prop('selected', 'selected'), r.parent().trigger('change');
          }
        });
      },
    };
        ...
        var i = new r(e, {
          ...
          onCreditCardTypeChanged: function (e) {
            var i = {
              ...
              r = i[Object.keys(i).indexOf(e) > -1 ? e : 'unknown'];
            $(t).val(r),
      ...
      function (e) {
        var i =
          ...
          r = function (e, t, i, n, a, s, o, d, l, c) {
            (this.numeralDecimalMark = e || '.'),
              ...
              (this.numeralThousandsGroupStyle = n || r.groupStyle.thousand),
          ...
          getFixedDateString: function (e) {
            ...
            return (
              ...
              8 === e.length &&
                ...
                (t = parseInt(e.slice(c, c + 2), 10)),
                (i = parseInt(e.slice(u, u + 2), 10)),
                (r = parseInt(e.slice(p, p + 4), 10)),
                (m = 4 === e.slice(p, p + 4).length),
              ...
              t.blocks.forEach(function (n, a) {
                if (e.length > 0) {
                  ...
                  switch (t.timePattern[a]) {
                    case 'h':
                      parseInt(o, 10) > r.maxHourFirstDigit
                        ? (s = '0' + o)
                        : parseInt(s, 10) > r.maxHours && (s = r.maxHours + '');
                      break;
                    case 'm':
                    case 's':
                      parseInt(o, 10) > r.maxMinutesFirstDigit
                        ? (s = '0' + o)
                        : parseInt(s, 10) > r.maxMinutes &&
                          (s = r.maxMinutes + '');
                  }
                  (i += s), (e = d);
                }
        ...
        var c = l,
          ...
          m = {
            ...
            getPrefixStrippedValue: function (e, t, i, r, n, a, s, o, d) {
              if (0 === i) return e;
              if (e === t && '' !== e) return '';
              if (d && '-' == e.slice(0, 1)) {
    ...
    !(function (e) {
      e.fn.checkout = function () {
        var t = this,
          ...
          n = ['customer', 'shipping', 'payment', 'placeOrder', 'submitted'];
        function s(e) {
          history.pushState(
            n[e],
            document.title,
        ...
        var o = {
                ...
                e.ajax({
                  ...
                  success: function (e) {
                    e.redirectUrl
                      ...
                      : r.methods.customerFormResponse(i, e);
                  },
                  error: function (e) {
                    e.responseJSON &&
                  ...
                  e.ajax({
                    ...
                    success: function (t) {
                      e('body').trigger(
                        ...
                        a.methods.shippingFormResponse(i, t);
                    },
                    error: function (t) {
                      e('body').trigger(
                        'checkout:enableButton',
          ...
          initialize: function () {
            (o.currentStage = n.indexOf(
              ...
              e(window).on('popstate', function (e) {
                null === e.state || n.indexOf(e.state) < o.currentStage
                  ? o.handlePrevStage(!1)
          ...
          handleNextStage: function (i) {
            o.currentStage < n.length - 1 &&
              (o.currentStage++, i && s(o.currentStage)),
              e(t).attr('data-checkout-stage', n[o.currentStage]);
          },
          handlePrevStage: function () {
            o.currentStage > 0 && (o.currentStage--, s(o.currentStage)),
              e(t).attr('data-checkout-stage', n[o.currentStage]);
          },
      ...
      updateCheckoutView: function () {
        $('body').on('checkout:updateCheckoutView', function (e, t) {
          t.csrfToken && $("input[name*='csrf_token']").val(t.csrfToken),
            r.methods.updateCustomerInformation(t.customer, t.order),
            ...
            s.methods.updateBillingInformation(t.order, t.customer, t.options),
      ...
      methods: {
        ...
        updateCustomerInformation: function (e, t) {
          var i = $('.customer-summary'),
            ...
            n = e.profile && e.profile.email ? e.profile.email : t.orderEmail;
  ...
  function (e, t, i) {
    ...
    function s(e, t, i, n) {
      var a,
        ...
        d = i.shipping,
        l = !1;
      o && o.length > 0 && ((a = o[0].form), (s = $('.addressSelector', a))),
        s &&
          1 === s.length &&
          (s.empty(),
        ...
        l ? $(a).removeClass('hide-details') : $(a).addClass('hide-details'),
        ...
        $('input[value=' + e.UUID + ']').each(function (e, i) {
          ...
          if (r) {
            ...
            $('input[name$=_firstName]', r).val(t.firstName),
              ...
              $('select[name$=_stateCode],input[name$=_stateCode]', r).val(
                t.stateCode
              ),
              n && 'object' == typeof n
                ? $('select[name$=_country]', r).val(t.countryCode.value)
                : $('select[name$=_country]', r).val(t.countryCode),
              $('input[name$=_phone]', r).val(t.phone),
              $('input[name$=_isGift]', r).prop('checked', t.isGift),
          ...
          if (r) {
            ...
            if (n && n.length > 0) {
              ...
              var a = e.applicableShippingMethods,
                ...
                o = r.name + '_shippingAddress_shippingMethodID';
              $.each(a, function (t, i) {
                var r = $('#shipping-method-template').clone();
                $('input', r)
                  .prop('id', 'shippingMethod-' + i.ID + '-' + e.UUID)
                  .prop('name', o)
                  .prop('value', i.ID)
                  .attr('checked', i.ID === s.ID),
                  $('label', r).prop(
                    'for',
                    'shippingMethod-' + i.ID + '-' + e.UUID
                  ),
                  $('.display-name', r).text(i.displayName),
                  i.estimatedArrivalTime &&
                    $('.arrival-time', r)
                      .text('(' + i.estimatedArrivalTime + ')')
                      .show(),
                  $('.shipping-cost', r).text(i.shippingCost),
                  n.append(r.html());
              });
            }
          }
        ...
        $('input[value=' + e.UUID + ']').each(function (e, t) {
          ...
          if (i) {
            $('input[name$=_firstName]', i).val(''),
              ...
              $('input[name$=_emailAddress]', i).val(''),
    ...
    e.exports = {
      ...
      selectShippingMethod: function () {
        ...
        $('.shipping-method-list').change(function () {
          ...
          (a.shipmentUUID = n),
            ...
            (a.giftMessage = t.find('textarea[name$=_giftMessage]').val());
                    ...
                    : t.order.shipping.forEach(function (e) {
                        $('input[value=' + e.UUID + ']').each(function (t, i) {
                          ...
                          if (r) {
                            ...
                            $(n).prop('selected', !0),
                              $('input[name$=_isGift]', r).prop('checked', !1),
                              $('textarea[name$=_giftMessage]', r).val(''),
                              $(r).find('.gift-message').addClass('d-none');
                          }
                        });
                      }),
                  i
      ...
      saveMultiShipInfo: function () {
        ...
        $('.btn-save-multi-ship').on('click', function (t) {
          ...
          return (
            r.spinner().start(),
            $.ajax({ url: s, type: 'post', dataType: 'json', data: a })
              .done(function (t) {
                n.clearPreviousErrors(i),
                  t.error
                    ...
                    : ($('body').trigger('checkout:updateCheckoutView', {
                      ...
                      e.methods && e.methods.viewMultishipAddress
                        ? e.methods.viewMultishipAddress(r)
                        : v(r)),
                  t.order &&
                    t.order.shippable &&
  ...
  function (e, t, i) {
    ...
    function a(e, t) {
      ...
      a &&
        ...
        (a.empty(),
        a.append(
          r.methods.optionValueForAddress(null, !1, e, { type: 'billing' })
        ),
        a.append(
          r.methods.optionValueForAddress(
        ...
        i.forEach(function (t) {
          ...
          (s = s || i),
            a.append(
              r.methods.optionValueForAddress(t, i, e, { type: 'billing' })
            );
        }),
        t.addresses &&
          t.addresses.length > 0 &&
          (a.append(
            r.methods.optionValueForAddress(e.resources.accountAddresses, !1, e)
          ),
        ...
        s || (!e.billing.matchingAddressId && e.billing.billingAddress.address)
    ...
    function o() {
      s({ billing: { billingAddress: { address: { countryCode: {} } } } });
    }
    function d(e) {
        ...
        updateBillingAddress: function (e) {
          ...
          if (t.billingAddress && t.billingAddress.address) {
            ...
            i &&
              ...
              $('input[name$=_emailAddress]', i).val(
                t.billingAddress.address.emailAddress
              ),
              $('input[name$=_address1]', i).val(
        ...
        validateAndUpdateBillingPaymentInstrument: function (e) {
          ...
          if (
            ...
            if (i) {
              ...
              $('select[name$=expirationMonth]', i).val(r.expirationMonth),
                $('select[name$=expirationYear]', i).val(r.expirationYear),
      ...
      updateOrderProductSummaryInformation: function (e) {
        ...
        e.shipping.forEach(function (i) {
          ...
          (i.shippingAddress.phone || i.productLineItems.items[0].fromStoreId)
            ? ($('.ship-to-name', p).text(a),
              $('.ship-to-address1', p).text(s),
              $('.ship-to-address2', p).text(o),
              $('.ship-to-city', p).text(r.city),
              r.stateCode && $('.ship-to-st', p).text(r.stateCode),
              $('.ship-to-zip', p).text(r.postalCode),
              $('.ship-to-phone', p).text(d),
              o || $('.ship-to-address2', p).hide(),
              d || $('.ship-to-phone', p).hide(),
              v.find('.ship-to-message').text(''))
            : v.find('.ship-to-message').text(e.resources.addressIncomplete),
            i.isGift
              ? $('.gift-message-summary', p).text(i.giftMessage)
              : $('.gift-summary', p).addClass('d-none');
          ...
          $('body').trigger('shipping:updateAddressLabelText', {
            ...
            i.selectedShippingMethod &&
              ($('.display-name', p).text(c),
              $('.arrival-time', p).text(u),
              $('.price', p).text(l));
          var b = $(
