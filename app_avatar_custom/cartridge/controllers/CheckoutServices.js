...
var firstPurchase = require('*/cartridge/scripts/steps/firstPurchase');
...
server.get('Get', server.middleware.https, function (req, res, next) {
  ...
  res.json({
    ...
    message: allValid
      ? ''
      : Resource.msg('error.message.shipping.addresses', 'checkout', null),
  });
 ...
 */
function handleCustomerRouteBeforeComplete(
  req,
  res,
  accountModel,
  redirectUrl
...
server.post(
  ...
  function (req, res, next) {
    ...
    viewData.customerLoginResult = accountHelpers.loginCustomer(
    ...
    this.on('route:BeforeComplete', function (req, res) {
      ...
      var accountModel = new AccountModel(
        viewData.customerLoginResult.authenticatedCustomer
      );
      var redirectUrl = URLUtils.https('Checkout-Begin', 'stage', 'shipping')
        .abs()
        .toString();
  ...
  function (req, res, next) {
    ...
    if (Object.keys(billingFormErrors).length) {
      ...
      viewData.address = {
        ...
        emailAddress: { value: paymentForm.addressFields.emailAddress.value },
    ...
    this.on('route:BeforeComplete', function (req, res) {
      ...
      Transaction.wrap(function () {
        ...
        billingAddress.custom.emailAddress =
          billingData.address.emailAddress.value;
        ...
        if (
          Object.prototype.hasOwnProperty.call(billingData.address, 'stateCode')
        ) {
...
server.post('PlaceOrder', server.middleware.https, function (req, res, next) {
  ...
  var currentBasket = BasketMgr.getCurrentBasket();
  let customerData = currentBasket.customer;
  ...
  firstPurchase.validateFirstPurchase(currentBasket, customerData);
